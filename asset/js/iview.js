	...
	iView.prototype = {
		...
		addStrips: function (vertical, opts) {
			...
			for (var i = 0; i < opts.strips; i++) {
				var stripWidth = iv.mathRound(iv.slider.width() / opts.strips),
					stripHeight = iv.mathRound(iv.slider.height() / opts.strips),
		...
		addBlocks: function () {
			var iv = this,
				blockWidth = iv.mathRound(iv.slider.width() / iv.options.blockCols),
				blockHeight = iv.mathRound(iv.slider.height() / iv.options.blockRows);
