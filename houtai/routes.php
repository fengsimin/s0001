...
#==== GET admin/backup/:target

$o['GET']['admin/backup/:target']=array (
  'class_name' => 'Admin',
  'method_name' => 'getBackup',
  'arguments' => 
  array (
...
#==== GET order/one/:id/:column

$o['GET']['order/one/:id/:column']=array (
  'class_name' => 'Order',
  'method_name' => 'getOne',
  'arguments' => 
  array (
...
#==== GET order/images/:pid

$o['GET']['order/images/:pid']=array (
  'class_name' => 'Order',
  'method_name' => 'getImages',
  'arguments' => 
  array (
...
$o['GET']['order/error/:message']=array (
  'class_name' => 'Order',
  'method_name' => 'error',
  'arguments' => 
  array (
...
#==== GET order/error/:message/:data

$o['GET']['order/error/:message/:data']=array (
  'class_name' => 'Order',
  'method_name' => 'error',
  'arguments' => 
  array (
...
$o['GET']['order/success/:message']=array (
  'class_name' => 'Order',
  'method_name' => 'success',
  'arguments' => 
  array (
...
#==== GET order/success/:message/:data

$o['GET']['order/success/:message/:data']=array (
  'class_name' => 'Order',
  'method_name' => 'success',
  'arguments' => 
  array (
...
#==== GET order/result/:code

$o['GET']['order/result/:code']=array (
  'class_name' => 'Order',
  'method_name' => 'result',
  'arguments' => 
  array (
...
#==== GET order/result/:code/:message

$o['GET']['order/result/:code/:message']=array (
  'class_name' => 'Order',
  'method_name' => 'result',
  'arguments' => 
  array (
...
#==== GET order/result/:code/:message/:data

$o['GET']['order/result/:code/:message/:data']=array (
  'class_name' => 'Order',
  'method_name' => 'result',
  'arguments' => 
  array (
...
#==== POST order/removeimage

$o['POST']['order/removeimage']=array (
  'class_name' => 'Order',
  'method_name' => 'postRemoveImage',
  'arguments' => 
  array (
...
#==== POST order/removeimage/:id

$o['POST']['order/removeimage/:id']=array (
  'class_name' => 'Order',
  'method_name' => 'postRemoveImage',
  'arguments' => 
  array (
...
#==== POST order/removeimage/:id/:prefix

$o['POST']['order/removeimage/:id/:prefix']=array (
  'class_name' => 'Order',
  'method_name' => 'postRemoveImage',
  'arguments' => 
  array (
...
#==== POST order/removeimage2

$o['POST']['order/removeimage2']=array (
  'class_name' => 'Order',
  'method_name' => 'postRemoveImage2',
  'arguments' => 
  array (
...
#==== POST order/removefile2

$o['POST']['order/removefile2']=array (
  'class_name' => 'Order',
  'method_name' => 'postRemoveFile2',
  'arguments' => 
  array (
